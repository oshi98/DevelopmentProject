            ...
            <div class="row mg-b-25">
              ...
              <div class="col-lg-4">
                <div class="form-group">
                  ...
                  <input class="form-control" type="text" name="selling_price" placeholder="">
                </div>
              </div><!-- col-4 -->
              ...
              <div class="col-lg-4">
                <div class="form-group">
                  ...
                  <label class="custom-file">
                    ...
                    <img src="#" id="one" alt="product image">
                  </label>
                </div>
              </div><!-- col-4 -->
              ...
              <div class="col-lg-4">
                <div class="form-group">
                  ...
                  <label class="custom-file">
                    ...
                    <span class="custom-file-control"></span>
                    <img src="#" id="two" alt="product image">
                  </label>
                </div>
              </div><!-- col-4 -->
              ...
              <div class="col-lg-4">
                <div class="form-group">
                  ...
                  <label class="custom-file">
                    ...
                    <span class="custom-file-control"></span>
                    <img src="#" id="three" alt="product image">
                  </label>
                </div>
              </div><!-- col-4 -->
            </div><!-- row -->
