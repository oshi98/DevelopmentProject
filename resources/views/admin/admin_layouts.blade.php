...
<html lang="en">
  <head>
    ...
    <title>Laksiri Plant Nursery Admin Dashboard</title>
  ...
  <body>
    ...
    @else
  <!-- ########## START: LEFT PANEL ########## -->
  <div class="sl-logo"><a href=""> Laksiri Plants</a></div>
  <div class="sl-sideleft">
    ...
    <div class="sl-sideleft-menu">
      ...
      <ul class="sl-menu-sub nav flex-column">
        ...
        <!-- <li class="nav-item"><a href="chart-chartjs.html" class="nav-link"></a></li>
        <li class="nav-item"><a href="chart-rickshaw.html" class="nav-link"></a></li>
        <li class="nav-item"><a href="chart-sparkline.html" class="nav-link"></a></li> -->
      </ul>
      <a href="#" class="sl-menu-link">
        <div class="sl-menu-item">
      ...
      <ul class="sl-menu-sub nav flex-column"> 
        <!-- <li class="nav-item"><a href="map-google.html" class="nav-link"></a></li>
      ...
      <nav class="nav">
        <div class="dropdown">
          <a href="" class="nav-link nav-link-profile" data-toggle="dropdown">
            ...
            <img src="{{asset('public/backend/img/icons8-male-user-48.png')}}" class="wd-32 rounded-circle" alt="">
          </a>
