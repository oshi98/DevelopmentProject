	...
	<div class="cart_section">
		...
		<li class="cart_item clearfix">
           ...
           <form method="post" action="{{ route('update.cartitem') }}">
           	...
           	<button title= "Update" type="submit" class="btn btn-success btn-sm"><i class="fas fa-check-square"></i> </button>
	 ...
	 <a title= "Remove" href="{{ url('remove/cart/'.$row->rowId ) }}" class="btn btn-sm btn-danger">x</a>
				</div>
         ...
         <button type="submit" class="btn btn-danger ml-2">Submit      	
          ...
          <ul class="list-group col-lg-4" style="float: right;">
              ...
              <a title= "Delete" href="{{ route('coupon.remove') }}" class="btn btn-danger btn-sm">X</a>
           <span style="float: right;">Rs.{{ Session::get('coupon')['discount'] }} </span> </li>
          	...
          	@if(Session::has('coupon'))
          	<li class="list-group-item">Total : <span style="float: right;">Rs.{{ Session::get('coupon')['balance'] + $charge   }} </span> </li>
          	@else
      <li class="list-group-item">Total : <span style="float: right;">Rs.{{ Cart::Subtotal() + $charge   }} </span> </li>
          	@endif
